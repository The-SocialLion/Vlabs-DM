...
function plotSine(ctx, amplitude, frequency, xOffset, yOffset, vertical_scaling_factor, horizontal_scaling_factor) {
    ...
    let sampFreq=document.getElementById("saFreq").innerHTML;
    var fm=document.getElementById("fm");
    document.getElementById("bw").innerHTML = 1*(sampFreq/2)+" Kb/s" ;
    var Ts=1/(sampFreq);
    document.getElementById("pmax").innerHTML=((delta^2)/(8*(3.14^2)*(fm^2)*(Ts^2)))+" Watts";
    var W=sampFreq/2;
    document.getElementById("snr").innerHTML = (3*(sampFreq^3))/(8*(3.14^2)*(fm^2)*W) ;
