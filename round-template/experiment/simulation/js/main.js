...
const questions = {
    ...
    3: {
        "question": "In DM, the slope overload distortion can be reduced by",
        "options": [
        ...
        "answer": "Increasing the step size"
    },
    4: {
        "question": "Find the total number of bits transmitted per sample in DM.",
        "options": [
            "1",
            "2",
            "3",
...
function setup_modulation() {
    ...
    myblocks.set('adder1', new Adder1(myblocks.get('sampler'), myblocks.get('quantizer'), myblocks.get('predfilter1'), 20));
    // myblocks.set('adder2', new Adder2(1460 - 120, 145 + 100, 20));
    myblocks.set('adder2', new Adder2(myblocks.get('quantizer'), myblocks.get('predfilter1'), myblocks.get('encoder'), 20));
}
